...
function switchLanguage(language) {
    ...
    if (language === 'da') {
        ...
        descriptionElement.innerHTML = 'We are a creative company<br>developing and producing<br>' +
          'entertainment.<br><br>Aren\'t we sweet?<br><br><label for="Ja">Sure</label><input type="checkbox" ' +
          'id="Ja"><label for="VedIkke">Not sure</label><input type="checkbox" id="VedIkke">' +
          '<label for="Naeh">Nah</label><input type="checkbox" id="Naeh">';
    }
}
